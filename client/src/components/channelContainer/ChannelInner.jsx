    ...
    return (
        <GiphyContext.Provider value={{ giphyState, setGiphyState }}>
            <div style={{ display: 'flex', width: '100%' }}>
                <Window>
                    <TeamChannelHeader setIsEditing={setIsEditing} isOpen={isOpen} setIsOpen={setIsOpen} channelMembers={channelMembers} />
                    <MessageList />
                    <MessageInput
...
const TeamChannelHeader = ({ setIsEditing, setIsOpen, isOpen, channelMembers }) => {
